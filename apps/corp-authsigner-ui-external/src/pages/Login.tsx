...
export const Login: React.FC = () => {
  ...
  const [email, setEmail] = useState('external@partner.com')
  const [password, setPassword] = useState('external-password')
    ...
    try {
      ...
      dispatch(uiActions.addNotification({
        notification: {
          ...
          message: 'Successfully logged in to external portal',
          dismissible: true,
        },
      }))
    } catch (error: any) {
    ...
    <div style={containerStyle}>
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="opacity-75">Sign in to access your signing dashboard</p>
        </div>
        ...
        <Card className="p-8">
          ...
          <div className="mt-6 text-center">
            ...
            <div className="text-sm opacity-75">
              ...
              <p>Email: external@partner.com</p>
              <p>Password: external-password</p>
            </div>
          </div>
        </Card>
      </div>
